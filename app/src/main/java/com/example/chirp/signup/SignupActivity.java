package com.example.chirp.signup;
...
public class SignupActivity extends AppCompatActivity {
    ...
    private TextInputLayout passwordInputField, confirmPasswordInputField;
    ...
    public void btnSignupClick(View v) {
        ...
        if (name.equals("")) {
            etName.setError(getString(R.string.missing_name));
        }else if (email.equals("")) {
            etEmail.setError(getString(R.string.missing_email));
        } else if (etPassword.equals("")) {
            passwordInputField.setEndIconVisible(false);
            etPassword.setError(getString(R.string.missing_password));
        } else if (confirmPassword.equals("")) {
            confirmPasswordInputField.setEndIconVisible(false);
            etConfirmPassword.setError(getString(R.string.missing_confirm_password));
